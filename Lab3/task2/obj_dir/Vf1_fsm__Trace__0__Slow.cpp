...
VL_ATTR_COLD void Vf1_fsm___024root__trace_init_sub__TOP__0(Vf1_fsm___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+6,"clk", false,-1);
    tracep->declBus(c+7,"data_out", false,-1, 7,0);
    tracep->declBus(c+1,"current_state", false,-1, 7,0);
    tracep->declBus(c+2,"next_state", false,-1, 7,0);
    tracep->declBus(c+3,"sreg", false,-1, 7,0);
...
VL_ATTR_COLD void Vf1_fsm___024root__trace_full_sub_0(Vf1_fsm___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullCData(oldp+1,(vlSelf->f1_fsm__DOT__current_state),8);
    bufp->fullCData(oldp+2,(vlSelf->f1_fsm__DOT__next_state),8);
    bufp->fullCData(oldp+3,(vlSelf->f1_fsm__DOT__sreg),8);
