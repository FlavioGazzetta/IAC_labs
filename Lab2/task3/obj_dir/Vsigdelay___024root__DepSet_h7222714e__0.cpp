...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    // Body
    vlSelf->__Vdly__sigdelay__DOT__addr_wr = vlSelf->sigdelay__DOT__addr_wr;
    if (vlSelf->rst) {
        vlSelf->__Vdly__sigdelay__DOT__addr_wr = 0U;
    } else if (vlSelf->wr) {
        vlSelf->__Vdly__sigdelay__DOT__addr_wr = (0x1ffU 
                                                  & ((IData)(1U) 
                                                     + (IData)(vlSelf->sigdelay__DOT__addr_wr)));
    }
}
...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__1(Vsigdelay___024root* vlSelf) {
    ...
    // Init
    SData/*8:0*/ __Vdlyvdim0__sigdelay__DOT__audio_ram__DOT__ram_memory__v0;
    CData/*7:0*/ __Vdlyvval__sigdelay__DOT__audio_ram__DOT__ram_memory__v0;
    CData/*0:0*/ __Vdlyvset__sigdelay__DOT__audio_ram__DOT__ram_memory__v0;
    // Body
    __Vdlyvset__sigdelay__DOT__audio_ram__DOT__ram_memory__v0 = 0U;
    if (vlSelf->wr) {
        __Vdlyvval__sigdelay__DOT__audio_ram__DOT__ram_memory__v0 
            = vlSelf->mic_signal;
        __Vdlyvset__sigdelay__DOT__audio_ram__DOT__ram_memory__v0 = 1U;
        __Vdlyvdim0__sigdelay__DOT__audio_ram__DOT__ram_memory__v0 
            = vlSelf->sigdelay__DOT__addr_wr;
    }
    vlSelf->sigdelay__DOT__ram_data_out = vlSelf->sigdelay__DOT__audio_ram__DOT__ram_memory
        [(0x1ffU & ((IData)(vlSelf->sigdelay__DOT__addr_wr) 
                    + (IData)(vlSelf->offset)))];
    if (__Vdlyvset__sigdelay__DOT__audio_ram__DOT__ram_memory__v0) {
        vlSelf->sigdelay__DOT__audio_ram__DOT__ram_memory[__Vdlyvdim0__sigdelay__DOT__audio_ram__DOT__ram_memory__v0] 
            = __Vdlyvval__sigdelay__DOT__audio_ram__DOT__ram_memory__v0;
    }
    vlSelf->delayed_signal = vlSelf->sigdelay__DOT__ram_data_out;
}
...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__2(Vsigdelay___024root* vlSelf) {
    ...
    // Body
    vlSelf->sigdelay__DOT__addr_wr = vlSelf->__Vdly__sigdelay__DOT__addr_wr;
}
