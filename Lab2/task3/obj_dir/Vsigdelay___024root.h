...
class Vsigdelay___024root final : public VerilatedModule {
  public:
    ...
    CData/*7:0*/ sigdelay__DOT__ram_data_out;
    CData/*0:0*/ __Vclklast__TOP__clk;
    CData/*0:0*/ __Vclklast__TOP__rst;
    VL_IN16(offset,8,0);
    SData/*8:0*/ sigdelay__DOT__addr_wr;
    SData/*8:0*/ __Vdly__sigdelay__DOT__addr_wr;
    VlUnpacked<CData/*7:0*/, 512> sigdelay__DOT__audio_ram__DOT__ram_memory;
