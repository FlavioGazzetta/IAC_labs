...
VL_ATTR_COLD void Vsigdelay___024root__trace_init_sub__TOP__0(Vsigdelay___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+6,"mic_signal", false,-1, 7,0);
    tracep->declBus(c+7,"delayed_signal", false,-1, 7,0);
    tracep->declBus(c+8,"addr_wr", false,-1, 8,0);
    tracep->declBus(c+9,"addr_rd", false,-1, 8,0);
    tracep->declBus(c+10,"ram_data_out", false,-1, 7,0);
    tracep->pushNamePrefix("audio_ram ");
    tracep->declBit(c+1,"clk", false,-1);
    tracep->declBus(c+8,"addr_wr", false,-1, 8,0);
    tracep->declBus(c+9,"addr_rd", false,-1, 8,0);
...
VL_ATTR_COLD void Vsigdelay___024root__trace_full_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullSData(oldp+8,(vlSelf->sigdelay__DOT__addr_wr),9);
    bufp->fullSData(oldp+9,((0x1ffU & ((IData)(vlSelf->sigdelay__DOT__addr_wr) 
                                       + (IData)(vlSelf->offset)))),9);
    bufp->fullCData(oldp+10,(vlSelf->sigdelay__DOT__ram_data_out),8);
}
