...
VL_ATTR_COLD void Vsigdelay___024root___ctor_var_reset(Vsigdelay___024root* vlSelf) {
    ...
    vlSelf->sigdelay__DOT__addr_wr = VL_RAND_RESET_I(9);
    vlSelf->sigdelay__DOT__ram_data_out = VL_RAND_RESET_I(8);
    for (int __Vi0=0; __Vi0<512; ++__Vi0) {
        vlSelf->sigdelay__DOT__audio_ram__DOT__ram_memory[__Vi0] = VL_RAND_RESET_I(8);
    }
    vlSelf->__Vdly__sigdelay__DOT__addr_wr = VL_RAND_RESET_I(9);
}
