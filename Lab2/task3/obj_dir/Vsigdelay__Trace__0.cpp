...
void Vsigdelay___024root__trace_chg_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgSData(oldp+7,(vlSelf->sigdelay__DOT__addr_wr),9);
    bufp->chgSData(oldp+8,((0x1ffU & ((IData)(vlSelf->sigdelay__DOT__addr_wr) 
                                      + (IData)(vlSelf->offset)))),9);
    bufp->chgCData(oldp+9,(vlSelf->sigdelay__DOT__ram_data_out),8);
}
